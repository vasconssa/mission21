...
ORIGINAL_CAPTION = "Mission 21"
COLOR_KEY = (255, 0, 255)
BACKGROUND_COLOR = (0, 0, 0)
BACKGROUND_COLOR2 = (30, 40, 50)

SCREEN_RECT = pg.Rect((0,0), SCREEN_SIZE)
_FONT_PATH = os.path.join("../assets", "fonts","military_font_7.ttf")
...
MUSIC = tools.load_all_music(os.path.join("../assets", "Audio"))
SFX   = tools.load_all_sfx(os.path.join("../assets", "Audio"))
...
def graphics_from_directories(directories):
    ...
    for directory in directories:
        ...
        GFX[directory] = tools.load_all_gfx(base_path)
    return GFX
